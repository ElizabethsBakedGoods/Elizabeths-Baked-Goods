...
const CONFIG = {
  emailjsPublicKey: "REPLACE_WITH_YOUR_EMAILJS_PUBLIC_KEY",
...
window.addEventListener("load", () => {
  if (window.emailjs && CONFIG.emailjsPublicKey !== "REPLACE_WITH_YOUR_EMAILJS_PUBLIC_KEY") {
...
async function safeSendEmail(serviceId, templateId, params) {
  ...
  if (serviceId.includes("REPLACE") || templateId.includes("REPLACE")) {
